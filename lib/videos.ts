...
export const FEATURE_FILMS = [
  {
    ...
    synopsis: 'A sharp, satirical Bollywood drama-comedy about ego, identity, and the extraordinary lengths humans go to protect both. When four characters collide — each convinced they are right — the film asks: what happens when ego becomes the only thing standing between you and everything you want?',
    cast: 'Arshad Warsi · Juhi Chawla · Divya Dutta · Gauhar Khan',
    castList: [
      { name: 'Arshad Warsi', role: '' },
      { name: 'Juhi Chawla', role: '' },
      { name: 'Divya Dutta', role: '' },
      { name: 'Gauhar Khan', role: '' },
    ],
    crew: [
      { role: 'Written & Directed by', name: 'Niddhish Puuzhakkal' },
      { role: 'Produced by', name: 'Niddhish Puuzhakkal, Gulab Singh Tanwar' },
      { role: 'Associate Producer', name: 'Zaki Peshimam' },
      { role: 'Cinematography', name: 'Jebin Jacob, Ravi Yadav' },
      { role: 'Editor', name: 'Richard Kevin' },
      { role: 'Music', name: 'Sreerag Saji' },
      { role: 'Art Direction', name: 'Ankita Dhar' },
      { role: 'Costume', name: 'Sameera Saneesh' },
      { role: 'Post Production', name: 'Red Chillies Entertainment' },
      { role: 'Production House', name: 'Light Seeker Films · Saarthil' },
    ],
  ...
  },
  {
    ...
    synopsis: 'A quiet, intimate Hindi drama currently completing post-production. Details to be announced.',
    cast: 'Cast to be announced',
    castList: [],
    crew: [
      { role: 'Written & Directed by', name: 'Niddhish Puuzhakkal' },
      { role: 'Production House', name: 'Light Seeker Films' },
    ],
  ...
  {
    slug: 'canvas',
    title: 'Kabirinte Canvas',
    year: '2025',
    genre: 'Drama',
    language: 'Malayalam',
    tagline: 'Every life is a work in progress.',
    synopsis: 'A one-of-a-kind Malayalam film currently in production. Kabirinte Canvas explores the intersections of art, identity, and human longing through the lens of a painter navigating his fractured world.',
    cast: 'Niddhish Puuzhakkal · Sudhy Kopa · Mamu Koya · Vijay Menon',
    castList: [
      { name: 'Niddhish Puuzhakkal', role: '' },
      { name: 'Sudhy Kopa', role: '' },
      { name: 'Mamu Koya', role: '' },
      { name: 'Vijay Menon', role: '' },
    ],
    crew: [
      { role: 'Written, Directed & Produced by', name: 'Niddhish Puuzhakkal' },
      { role: 'Sound', name: 'Rameez K Subair' },
      { role: 'Editor', name: 'Ajay Devaloka' },
      { role: 'Music', name: 'Micu Patel' },
      { role: 'Post Production', name: 'Light Seeker Post' },
    ],
...
export type FeatureFilm = typeof FEATURE_FILMS[number]
