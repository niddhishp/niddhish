  ...
  return (
    <section style={{
      ...
      <div style={{ maxWidth: 860, margin: '0 auto', textAlign: 'center' }}>
        ...
        >
          <span className="text-label" style={{ display: 'block', marginBottom: '1rem', color: 'var(--color-text-tertiary)' }}>
            Start a Project
          </span>
          <h2
            className="text-display-sm"
            style={{ color: 'var(--color-text-primary)', marginBottom: '1rem', lineHeight: 1.15 }}
          >
          ...
          <p style={{
            ...
            marginBottom: '3rem', maxWidth: 540, margin: '0 auto 3rem',
          }}>
            Every great collaboration starts with a clear brief.
        ...
        {status === 'done' ? (
          <motion.div
            ...
            style={{
              padding: '3.5rem 2.5rem', border: '0.5px solid var(--color-border-accent)',
              background: 'rgba(216,90,48,0.06)', borderRadius: 2, textAlign: 'center',
            }}
          >
            <ApertureMark size={36} />
            <p style={{
              fontFamily: 'var(--font-playfair,serif)', fontSize: 22,
              fontStyle: 'italic', color: 'var(--color-text-primary)', margin: '1.5rem 0 0.75rem',
            }}>
              Brief received.
            </p>
          ...
          >
            ...
            <fieldset style={{ border: 'none', padding: 0, marginBottom: '2rem' }}>
              <legend className="text-label" style={{ display: 'block', marginBottom: '1rem', textAlign: 'left' }}>
                Project type
              </legend>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem', marginBottom: '1rem' }}>
              {[
                ...
                <div key={f.id}>
                  ...
                  <input id={`invite-${f.id}`} type={f.type} required value={f.val}
            ...
            <div style={{ marginBottom: '1.75rem' }}>
              <label htmlFor="invite-brief" className="text-label" style={{ display: 'block', marginBottom: '0.5rem' }}>
                The Brief
              </label>
              <textarea
                id="invite-brief" required rows={5} value={brief}
                onChange={e => setBrief(e.target.value)}
                placeholder="Tell me about the project — the brand, the objective, the audience, and what success looks like to you."
            ...
            {status === 'error' && (
              <p style={{ fontSize: 13, color: '#e05555', marginBottom: '1rem' }}>
